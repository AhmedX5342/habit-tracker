...
export default function Settings({ data, diary, onSaveData, onSaveDiary }: SettingsProps) {
  ...
  const clearAllData = async () => {
    ...
    const emptyData: HabitData = { habits: [], entries: {} }
    const emptyDiary: Record<string, DiaryEntry> = {}
    
    await onSaveData(emptyData)
    await onSaveDiary(emptyDiary)
      ...
      <div className="settings-card">
        ...
        <div className="export-options">
          ...
          <button 
            ...
            onClick={exportFormat === 'json' ? exportAsJSON : exportAsExcel}
          >
      ...
      <div className="settings-card">
        ...
        <div className="stats-grid-mini">
          <div className="stat-mini">
            <span className="stat-mini-label">Total Habits</span>
            <span className="stat-mini-value">{totalHabits}</span>
          </div>
          <div className="stat-mini">
            <span className="stat-mini-label">Days Tracked</span>
            <span className="stat-mini-value">{totalEntries}</span>
          </div>
          <div className="stat-mini">
            <span className="stat-mini-label">Diary Entries</span>
            <span className="stat-mini-value">{totalDiaryEntries}</span>
          </div>
          <div className="stat-mini">
            <span className="stat-mini-label">Total Passes</span>
            <span className="stat-mini-value">{totalPasses()}</span>
          </div>
          <div className="stat-mini">
            <span className="stat-mini-label">Total Fails</span>
            <span className="stat-mini-value">{totalFails()}</span>
          </div>
          <div className="stat-mini">
